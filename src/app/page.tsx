      ...
      <main className="flex-1 flex flex-col">
        <section className="flex flex-col items-center justify-center px-6 pt-24 pb-20">
          <div className="max-w-3xl text-center space-y-6">
            ...
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight leading-tight">
              ...
              <br />
              <span className="text-emerald-400">to operational confidence</span>
            </h1>
        ...
        <section className="px-6 py-20 border-t border-gray-800/50">
          <div className="max-w-5xl mx-auto">
            <p className="text-sm font-medium tracking-widest text-emerald-400 uppercase text-center mb-3">
              Design Principles
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Summary card */}
              <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-6 flex flex-col justify-center space-y-3">
                <p className="text-sm font-medium text-emerald-400 tracking-wide uppercase">The Result</p>
        ...
        <section className="px-6 py-20 border-t border-gray-800/50">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {/* PMO Lead */}
              <div className="flex items-start gap-5 rounded-xl border border-gray-800 bg-gray-900/50 p-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full bg-gray-800 text-gray-400">Governance Enablement</span>
                  </div>
              ...
              <div className="flex items-start gap-5 rounded-xl border border-gray-800 bg-gray-900/50 p-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full bg-gray-800 text-gray-400">Delivery &amp; Coordination</span>
                  </div>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="flex items-start gap-5 rounded-xl border border-gray-800 bg-gray-900/50 p-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full bg-gray-800 text-gray-400">Strategic Oversight</span>
                  </div>
                  <p className="text-gray-400 leading-relaxed">
